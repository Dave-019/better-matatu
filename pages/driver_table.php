...
<body class="bg-base-100 font-['cascadia','lora']">
    <div class="flex flex-col items-center justify-center py-6 px-4">
        <div class="max-w-4xl w-full">
            ...
            <?php endif; ?>
            <div class="w-full overflow-x-auto max-w-4xl border border-primary/20 rounded-box">
                <table class="table">
                    <thead>
                        <tr>
                        ...
                        <?php if (isset($matatus) && !empty($matatus)): ?>
                            <?php foreach ($matatus as $matatu): ?>
                                <tr class="bg-primary/10">
                                    <td class="text-nowrap"><?php echo htmlspecialchars($matatu['reg_num']); ?></td>
                                    <td class="text-nowrap"><?php echo htmlspecialchars($matatu['driver_name']); ?></td>
                                    <td>
                                        <?php
                                        $statusClass = '';
                                    ...
                                    <td class="text-nowrap"><?php echo htmlspecialchars(date('F j, Y', strtotime($matatu['created_at']))); ?></td>
                                    <td>
